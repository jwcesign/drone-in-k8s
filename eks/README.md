...
> This is based on: https://github.com/terraform-aws-modules/terraform-aws-eks/tree/master/examples/eks_managed_node_group
...
## CloudPilot AI related

If you want to test GPU nodes rebalane, please do as follows before installing cloudpilot agent:
